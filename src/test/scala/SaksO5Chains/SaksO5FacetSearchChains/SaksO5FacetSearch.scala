package SaksO5Chains.SaksO5FacetSearchChains
...
/**
  ...
  */
object SaksO5FacetSearch extends BaseTest{
  val FacetSearch_Transaction = instance + "FacetSearch_Transaction"
  ...
  val SaksFacetSearch = group(FacetSearch_Transaction) {
      ...
      session.set("startTime", startTime)
        ...
        .exec(session => {
          ...
          insertGroupResponseTime(session("startTime").as[Long],EndTime,instance + "SaksO5_FacetSearch")
          session
