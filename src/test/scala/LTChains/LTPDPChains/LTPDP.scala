...
/**
  ...
  */
object LTPDP extends BaseTest{

  val LTPDP = group("LTPDP_Transaction") {
      exec(http("PDP Search")
        .get(baseUrlHttps + "/webapp/wcs/stores/servlet/en/SearchDisplay?storeId=${StoreID}&catalogId=${catalogID}&langId=-1&pageSize=12&beginIndex=0&sType=SimpleSearch&resultCatEntryType=2&showResultsPage=true&pageView=image&searchSource=Q&searchTerm=${ProductID}&x=0&y=0")
